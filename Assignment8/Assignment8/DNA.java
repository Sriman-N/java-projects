...
public class DNA {
    ...
    public void createDatabaseOfProfiles ( String filename ) {
        ...
        for(int i = 0; i < p; i++) {
            ...
            String pSTR1 = StdIn.readLine();
            String pSTR2 = StdIn.readLine();
            database[i] = new Profile(pname, null, null, pSTR1, pSTR2);
        }
    ...
    public Profile createUnknownProfile ( String filename ) {
        ...
        Profile p = new Profile("Unknown", null, null, pSTR1, pSTR2);
    ...
    public STR findSTRInSequence ( String sequence, String STR ) {
        ...
        STR str = new STR(STR, numOfRepeats);
    ...
    public void createProfileSTRs ( Profile profile, String[] allSTRs ) {
        ...
        //findSTRInSequence(profile.getSequence1(), allSTRs);

        STR[] str1array = new STR[allSTRs.length];
        STR[] str2array = new STR[allSTRs.length];
        String sequence1 = profile.getSequence1();
        String sequence2 = profile.getSequence2();

        for(int i = 0; i < allSTRs.length; i++) {
            str1array[i] = findSTRInSequence(sequence1, allSTRs[i]);
            str2array[i] = findSTRInSequence(sequence2, allSTRs[i]);
        }

        profile.setS1_STRs(str1array);
        profile.setS2_STRs(str2array);
	...
	return arrayList; // update the return value
    }
